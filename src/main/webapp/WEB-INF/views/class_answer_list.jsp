    ...
    layui.use(['laypage', 'layer','laydate','jquery','form'],function() {
        ...
        var thisDate = function (curr) {
            ...
            for (var i = (curr * nums - nums); i <= last; i++) {
                ...
                var td2 = $("<td align='center'><a href="+"/rest/class_answer_detail?classId="+classId+"&testId="+testId+"&testName="+testName+"><input type='button' class='layui-btn' value='查看详情'/></a></td>");
                td0.appendTo(tr);
                td1.appendTo(tr);
                td2.appendTo(tr);
                tr.appendTo(table);
