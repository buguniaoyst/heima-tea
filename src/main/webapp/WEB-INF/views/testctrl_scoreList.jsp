...
<script>
    layui.use(['laypage', 'layer','laydate','jquery','form'],function() {
        ...
        $(function(){
            ...
            $.ajax({
                type: "GET",
                url: "${pageContext.request.contextPath}/rest/test/scoreList",
                //记得加双引号  T_T
        ...
        var thisDate = function (curr) {
            ...
            for (var i = (curr * nums - nums); i <= last; i++) {
                ...
                var td5 = $("<td align='center'><button class='layui-btn layui-btn-radius'  onclick='showScoreDetail("+testId+","+classId+");'>查看详情</button></td>");
                td1.appendTo(tr);
                td2.appendTo(tr);
                td3.appendTo(tr);
                td4.appendTo(tr);
    ...
    //查看分数详情
    function showScoreDetail(testid,classId) {
        //location.href = "${pageContext.request.contextPath}/rest/test/showScoreDetail?testId="+testid;
        location.href = "${pageContext.request.contextPath}/rest/score_detail?testId="+testid+"&classId="+classId;
    }
